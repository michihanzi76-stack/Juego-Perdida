// Escaleras P1
class Trabajo_piso extends Phaser.Scene {  
    constructor() {  
        super({ 
            key: "Trabajo_piso"
        });  
    ...
    preload() {  
        const base = "assets/";
        this.load.image("trabajo2", base + "trabajo2.png");
    }  
    ...
    create() {  
        ...
        const fondo = this.add.image(width / 2, height / 2, "trabajo2");
        //fondo.setScale(Math.max(width / fondo.width, height / fondo.height)).setScrollFactor(0);
        this.fondo = this.add.tileSprite(width/2, height/1.6, width, height, "trabajo2");
        ...
        this.cocina = this.physics.add.staticImage(840, height - sueloAltura - 100, "Farriba")  
            .setScale(0.7).refreshBody();
        
        this.comedor = this.physics.add.staticImage(240, height - sueloAltura - 100, "Fabajo")  
            .setScale(0.7).refreshBody();
    ...
    cocinar() {  
        ...
        this.tweens.add({  
            ...
            ease: 'Linear',  
            onComplete: () => {  
                this.scene.start("Trabajo_piso2");  
            }  
        });  
    }
