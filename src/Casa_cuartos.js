// PASILLO de cuartos P2
class Casa_cuartos extends Phaser.Scene {  
    constructor() {  
        super({ 
            key: "Casa_cuartos"
        });  
    ...
    preload() {  
        ...
        this.load.image("fondo_pasillo", base + "fondo_pasillo.png"); //casa
        this.load.image("piso", base + "piso.png");
         this.load.image("Puerta1", base + "Puerta1.png");
    ...
    create() {  
        ...
        const fondo = this.add.image(width / 2, height / 2, "fondo_pasillo");  
        //fondo.setScale(Math.max(width / fondo.width, height / fondo.height)).setScrollFactor(0);
        this.fondo = this.add.tileSprite(width/2, height/1.6, width, height, "fondo_pasillo");
        ...
        this.cama = this.physics.add.staticImage(510, height - sueloAltura - 160, "Farriba")
