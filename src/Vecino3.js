// Interrogatorios
class Vecino3 extends Phaser.Scene {  
    constructor() {  
        super({ 
            key: "Vecino3"
        });  
    ...
    preload() {  
        ...
        this.load.image("vecino38", base + "vecino38.png");
    ...
    create() {  
        ...
        const fondo = this.add.image(width / 2, height / 2, "vecino38");  
        //fondo.setScale(Math.max(width / fondo.width, height / fondo.height)).setScrollFactor(0);
        this.fondo = this.add.tileSprite(width/2, height/1.6, width, height, "vecino38");
