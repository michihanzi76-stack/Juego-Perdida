// Segundo Piso P2
class Casa_piso extends Phaser.Scene {  
    constructor() {  
        super({ 
            key: "Casa_piso"
        });  
    ...
    preload() {  
        ...
        this.load.image("fondo_escalera", base + "fondo_escalera.png"); //casa
        this.load.image("piso", base + "piso.png");
        this.load.image("bajar", base + "bajar.png");
    ...
    create() {  
        ...
        const fondo = this.add.image(width / 2, height / 2, "fondo_escalera");  
        //fondo.setScale(Math.max(width / fondo.width, height / fondo.height)).setScrollFactor(0);
        this.fondo = this.add.tileSprite(width/2, height/1.6, width, height, "fondo_escalera");
        ...
        this.cocina = this.physics.add.staticImage(480, height - sueloAltura - 120, "Fabajo")  
            .setScale(0.7).refreshBody();
