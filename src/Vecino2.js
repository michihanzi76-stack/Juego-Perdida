// Interrogatorios
class Vecino2 extends Phaser.Scene {  
    constructor() {  
        super({ 
            key: "Vecino2"
        });  
    ...
    preload() {  
        ...
        this.load.image("vecino35", base + "vecino35.png");
    ...
    create() {  
        ...
        const fondo = this.add.image(width / 2, height / 2, "vecino35");  
        //fondo.setScale(Math.max(width / fondo.width, height / fondo.height)).setScrollFactor(0);
        this.fondo = this.add.tileSprite(width/2, height/1.6, width, height, "vecino35");
