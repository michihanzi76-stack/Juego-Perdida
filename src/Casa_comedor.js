//COMEDOR P1
class Casa_comedor extends Phaser.Scene {  
    constructor() {  
        super({ 
            key: "Casa_comedor"
        });  
    ...
    preload() {  
        ...
        this.load.image("fondo_comedor", base + "fondo_comedor.png"); //casa
    ...
    create() {  
        ...
        const fondo = this.add.image(width / 2, height / 2, "fondo_comedor");  
        //fondo.setScale(Math.max(width / fondo.width, height / fondo.height)).setScrollFactor(0);
        this.fondo = this.add.tileSprite(width/2, height/1.6, width, height, "fondo_comedor");
        ...
        /*this.cama = this.physics.add.staticImage(60, height - sueloAltura - 18, "cama")  
            .setScale(0.7).refreshBody();*/

        this.cocina = this.physics.add.staticImage(470, height - sueloAltura - 90, "Fabajo")  
            .setScale(0.7).refreshBody();
