//CUARTO MAMA
class Casa_mama extends Phaser.Scene {  
    constructor() {  
        super({ 
            key: "Casa_mama"
        });  
    ...
    preload() {  
        ...
        this.load.image("fondo_cuarto1", base + "fondo_cuarto1.png"); //casa
    ...
    create() {  
        ...
        const fondo = this.add.image(width / 2, height / 2, "fondo_cuarto1");  
        //fondo.setScale(Math.max(width / fondo.width, height / fondo.height)).setScrollFactor(0);
        this.fondo = this.add.tileSprite(width/2, height/1.6, width, height, "fondo_cuarto1");
        ...
        this.cama = this.physics.add.staticImage(80, height - sueloAltura - 100, "Fizquierda")  
            .setScale(0.7).refreshBody();

        /*this.cocina = this.physics.add.staticImage(470, height - sueloAltura - 18, "sala")  
