//COCINA P1
class Casa_cocina extends Phaser.Scene {  
    constructor() {  
        super({ 
            key: "Casa_cocina"
        });  
    ...
    preload() {  
        ...
        this.load.image("fondo_cocina", base + "fondo_cocina.png"); //casa
    ...
    create() {  
        ...
        const fondo = this.add.image(width / 2, height / 2, "fondo_cocina");  
        //fondo.setScale(Math.max(width / fondo.width, height / fondo.height)).setScrollFactor(0);
        this.fondo = this.add.tileSprite(width/2, height/1.6, width, height, "fondo_cocina");
        ...
        this.cocina = this.physics.add.staticImage(470, height - sueloAltura - 100, "Fabajo")  
