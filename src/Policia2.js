//  Policia2
class Policia2 extends Phaser.Scene {  
    constructor() {  
        super({ 
            key: "Policia2"
        });  
    ...
    preload() {  
        ...
        this.load.image("fondo_Comisaria", base + "fondo_Comisaria.png");
    }  
    ...
    create() {  
        ...
        const fondo = this.add.image(width / 2, height / 2, "fondo_Comisaria");  
        //fondo.setScale(Math.max(width / fondo.width, height / fondo.height)).setScrollFactor(0);
        this.fondo = this.add.tileSprite(width/2, height/1.6, width, height, "fondo_Comisaria");
        ...
        this.comedor = this.physics.add.staticImage(420, height - sueloAltura - 150, "Farriba")  
            .setScale(0.7).refreshBody();
