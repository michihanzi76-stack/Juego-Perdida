//COMEDOR P1
class Trabajo2 extends Phaser.Scene {  
    constructor() {  
        super({ 
            key: "Trabajo2"
        });  
    ...
    preload() {  
        ...
        this.load.image("trabajoD", base + "trabajoD.png"); //casa
    ...
    create() {  
        ...
        const fondo = this.add.image(width / 2, height / 2, "trabajoD");  
        //fondo.setScale(Math.max(width / fondo.width, height / fondo.height)).setScrollFactor(0);
        this.fondo = this.add.tileSprite(width/2, height/1.6, width, height, "trabajoD");
        ...
        this.cocina = this.physics.add.staticImage(80, height - sueloAltura - 45, "Fizquierda")  
            .setScale(0.7).refreshBody();
