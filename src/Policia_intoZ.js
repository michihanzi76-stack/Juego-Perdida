// Interrogatorios
class Policia_intoZ extends Phaser.Scene {  
    constructor() {  
        super({ 
            key: "Policia_intoZ"
        });  
    ...
    preload() {  
        ...
        this.load.image("fondo_intoZ", base + "fondo_intoZ.png");
    ...
    create() {  
        ...
        const fondo = this.add.image(width / 2, height / 2, "fondo_intoZ");  
        //fondo.setScale(Math.max(width / fondo.width, height / fondo.height)).setScrollFactor(0);
        this.fondo = this.add.tileSprite(width/2, height/1.6, width, height, "fondo_intoZ");
