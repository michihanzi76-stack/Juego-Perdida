// Interrogatorios
class Vecino extends Phaser.Scene {  
    constructor() {  
        super({ 
            key: "Vecino"
        });  
    ...
    preload() {  
        ...
        this.load.image("vecino29", base + "vecino29.png");
    ...
    create() {
        ...
        const fondo = this.add.image(width / 2, height / 2, "vecino29");  
        //fondo.setScale(Math.max(width / fondo.width, height / fondo.height)).setScrollFactor(0);
        this.fondo = this.add.tileSprite(width/2, height/1.6, width, height, "vecino29");
