// Escaleras P1
class Casa_escalera extends Phaser.Scene {  
    constructor() {  
        super({ 
            key: "Casa_escalera"
        });  
    ...
    preload() {  
        ...
        this.load.image("fondo_casaA", base + "fondo_casaA.png"); //casa
    }  
    ...
    create() {  
        ...
        const fondo = this.add.image(width / 2, height / 2, "fondo_casaA");  
        //fondo.setScale(Math.max(width / fondo.width, height / fondo.height)).setScrollFactor(0);
        this.fondo = this.add.tileSprite(width/2, height/1.6, width, height, "fondo_casaA");
        ...
        this.cama = this.physics.add.staticImage(60, height - sueloAltura - 100, "Fizquierda")  
            .setScale(0.7).refreshBody();

        this.cocina = this.physics.add.staticImage(670, height - sueloAltura - 127, "Farriba")  
            .setScale(0.7).refreshBody();
        
        this.comedor = this.physics.add.staticImage(220, height - sueloAltura - 175, "Farriba")  
            .setScale(0.7).refreshBody();
